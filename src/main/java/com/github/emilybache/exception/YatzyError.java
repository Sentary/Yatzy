...
/**
 *
 * Enumeration of error code raised by the Automation application Each enum contain an integer error code and a message that is the generic message associated to the
 * error code
 *
 * @author Ismail
 *
